...
const finalPrompt =
 ...
 ? systemPrompt + " 医療画像では、まず画像内の内容を具体的に説明する。薬剤や処方箋が含まれている場合は、読める薬の名前をできるだけ挙げ、それぞれについて用途を1行ずつ説明する。その後、全体としての意味や注意点を簡単にまとめる。見た目の感想だけで終わらせない。説明は必ず含める。内部では通常のChatGPTと同じレベルで分析してから答えること。"
    : normalizedType === "food"
