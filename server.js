...
const finalPrompt =
  ...
  ? systemPrompt + " 医療画像では、まず画像の種類を判断する。皮膚や見た目の写真なら、見た目の特徴、考えやすい状態、今できる対処を短く述べる。薬剤、処方箋、薬袋、検査票など文字情報が中心の画像なら、まず見える文字をできるだけ拾い、薬の名前や項目名を具体的に挙げる。そのうえで、それぞれの主な用途や意味を短く説明する。一般論だけで終わらせず、この画像に写っている内容を優先して説明する。基本はLINEらしく短くするが、薬や検査結果の説明は必要な分だけ少し長くしてよい。内部では通常のChatGPTと同じレベルで分析してから答えること。"
    : normalizedType === "food"
