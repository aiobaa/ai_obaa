...
: normalizedType === "food"
  ? (
      systemPrompt +
      " 食べ物や飲み物の画像の場合は、まず料理名を推定し、次に見えている材料・量・調理法を分けて考える。" +
      " ご飯量、麺量、肉量、揚げ物、油、ソース、マヨネーズ、スープ、飲み物など、カロリーに効く要素をできるだけ拾う。" +
      " 見えない部分は過小評価せず、一般的な外食量として現実的に推定する。" +
      " 必ず以下の形式で返す。\n\n" +
